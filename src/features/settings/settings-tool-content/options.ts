...
export const settingsSections: Array<{
  ...
  {
    description: "文本、整词、正则和自适应配色",
    icon: Highlighter,
    id: "settings-keyword-highlights",
    label: "关键词高亮",
  },
  {
...
export const settingsSearchEntries: Array<{
  ...
  {
    description: "全局终端文本、整词或安全正则高亮规则。",
    keywords: [
      "highlight",
      "keyword",
      "regex",
    ...
    sectionId: "settings-keyword-highlights",
    targetId: "settings-keyword-highlights-panel",
    title: "关键词高亮规则",
  },
  {
