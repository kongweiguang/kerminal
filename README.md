...
<div align="center">
  ...
  <p><sub>当前稳定版 v0.3.37 · Tauri 2 · Windows / Linux / macOS</sub></p>
</div>
...
前往 [GitHub Releases](https://github.com/kongweiguang/kerminal/releases/latest) 获取当前稳定版。v0.3.37 已公开提供以下产物：
